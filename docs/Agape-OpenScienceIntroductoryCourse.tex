...
\{\centering \includegraphics[width=0.5\linewidth]{images/slide2}

\}

\textbackslash caption\{Infographics(50\%)\}\label{fig:unnamed-chunk-2}
...
\{\centering \includegraphics[width=0.55\linewidth]{images/slide2}

\}

\textbackslash caption\{Infographics(55\%)\}\label{fig:unnamed-chunk-3}
\textbackslash end\{figure\}
...
\{\centering \includegraphics[width=0.6\linewidth]{images/slide2}

\}

\textbackslash caption\{Infographics(60\%)\}\label{fig:unnamed-chunk-4}
\textbackslash end\{figure\}
...
\{\centering \includegraphics[width=0.65\linewidth]{images/slide2}

\}

\textbackslash caption\{Infographics(65\%)\}\label{fig:unnamed-chunk-5}
\textbackslash end\{figure\}
...
\{\centering \includegraphics[width=0.7\linewidth]{images/slide2}

\}

\textbackslash caption\{Infographics(70\%)\}\label{fig:unnamed-chunk-6}
\textbackslash end\{figure\}
...
{\centering \includegraphics[width=0.75\linewidth]{images/slide2} 

}

\caption{Infographics(75)}\label{fig:unnamed-chunk-7}
\end{figure}
...
\{\centering \includegraphics[width=0.8\linewidth]{images/slide2}

\}

\textbackslash caption\{Infographics(80\%)\}\label{fig:unnamed-chunk-8}
\textbackslash end\{figure\}
...
\{\centering \includegraphics[width=0.9\linewidth]{images/slide2}

\}

\textbackslash caption\{Infographics(90\%)\}\label{fig:unnamed-chunk-9}
\textbackslash end\{figure\}
...
\{\centering \includegraphics[width=0.95\linewidth]{images/slide2}

\}

\textbackslash caption\{Infographics(95\%)\}\label{fig:unnamed-chunk-10}
\textbackslash end\{figure\}
...
\textbackslash caption\{Infographics(90\%)\}\label{fig:unnamed-chunk-11}
\textbackslash end\{figure\}

\textbackslash begin\{figure\}

\{\centering \includegraphics[width=1\linewidth]{images/slide2}

\}

\textbackslash caption\{Infographics(100\%)\}\label{fig:unnamed-chunk-12}
\textbackslash end\{figure\}
