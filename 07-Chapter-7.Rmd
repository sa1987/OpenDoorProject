...
<iframe src="https://sa1987.github.io/AgapeOSQuizChapter-7?embedded=true" width="100%" height="600" frameborder="0" marginheight="0" marginwidth="0"  style="border: 3px solid #3fb5bd;" >Loading…</iframe>
...
●       Check out the [](https://dri.ie/)[Digital Repository of Ireland](https://dri.ie/), the [](https://www.bas.ac.uk/data/uk-pdc/)[UK Polar Data Centre](https://www.bas.ac.uk/data/uk-pdc/) and the [](https://www.ncbi.nlm.nih.gov/)[National Centre for Biotechnology Information](https://www.ncbi.nlm.nih.gov/). How would you deposit data in each of them?
