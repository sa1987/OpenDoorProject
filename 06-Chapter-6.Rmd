...
The [](https://www.go-fair.org/fair-principles/)[FAIR principles](https://www.go-fair.org/fair-principles/) were first launched in 2014 at a [](https://www.lorentzcenter.nl/)[Lorentz Workshop](https://www.lorentzcenter.nl/) and officially published in 2016 with the focus on the EU’s goal of increasing sharing and reusing of research data. [](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=uriserv:OJ.L_.2019.172.01.0056.01.ENG)[The implementation of the FAIR principles](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=uriserv:OJ.L_.2019.172.01.0056.01.ENG) for research data is a requirement imposed by the EU, alongside the EU’s request on Open Science & Open Data. It is noteworthy that the FAIR principles are not a standard.
...
You can read more about DOIs on the official website of the [](https://www.doi.org/)[International DOI Foundation](https://www.doi.org/) (IDF).
...
&emsp; A1.1. The protocol is open, free and universally implementable.

&emsp; A1.2. The protocol allows for an authentication and authorization procedure, where necessary.
...
&emsp; R1.1. Metadata and data are released with a clear and accessible data usage licence.

&emsp; R1.2. Metadata and data are associated with detailed provenance.

&emsp; R1.3. Metadata and data meet domain-relevant community standards.
...
Earlier in this chapter, we learned about the concepts and categories of metadata, which play an important role in making your data FAIR. Remember to add metadata continuously to your research data, not just at the beginning or at the end of your project. You can read more about metadata standards and ontologies at [](https://www.dublincore.org/)[Dublin Core](https://www.dublincore.org/) and the [](http://rd-alliance.github.io/metadata-directory/)[RDA Metadata Standards Directory Working Group](http://rd-alliance.github.io/metadata-directory/). Don’t forget that your metadata must have a findable PID (persistent identifier) that is typically assigned when a digital resource is placed in a data repository.
...
●    You may find something interesting and suitable for you on the list of repositories recommended by the [](https://erc.europa.eu/funding-and-grants/managing-project/open-access)[European Research Council](https://erc.europa.eu/funding-and-grants/managing-project/open-access).

●    You can visit [](https://www.re3data.org/)[Re3data](https://www.re3data.org/), which is a global registry of research data repositories from various academic disciplines.

●    [](https://fairsharing.org/search?fairsharingRegistry=Database)[FAIRsharing](https://fairsharing.org/search?fairsharingRegistry=Database) allows you to discover databases grouped by domain, species or organisation.
...
●    And there is a lot more if you still want to browse for other repositories, such as [](https://explore.openaire.eu/participate/deposit/learn-how)[OpenAIRE](https://explore.openaire.eu/participate/deposit/learn-how), [](https://figshare.com/)[Figshare](https://figshare.com/), [](http://roar.eprints.org/)[ROAR](http://roar.eprints.org/), etc.

**Data licences**

A data licence is a legal arrangement between the creator of the data and the end-user/the place for data depositing, which specifies what users can do with the data. The most commonly used data licences are the suite of [](https://en.wikipedia.org/wiki/Creative_Commons)[Creative Commons](https://en.wikipedia.org/wiki/Creative_Commons) (CC) copyright licences, which concern reusability of the data and are irrevocable. Another widely known licence is [](https://en.wikipedia.org/wiki/Copyright)[Copyright](https://en.wikipedia.org/wiki/Copyright). You can learn more about licences in the chapter “Open science policy, scientific integrity and ethics”.
::::

## Test your understanding
<iframe src="https://sa1987.github.io/AgapeOSQuizChapter-6?embedded=true" width="100%" height="600" frameborder="0" marginheight="0" marginwidth="0"  style="border: 3px solid #3fb5bd;" >Loading…</iframe>
