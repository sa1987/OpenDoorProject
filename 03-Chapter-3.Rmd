...
It is no secret that the open science movement got its inspiration from the open-source culture movement. Open-source software refers to source code that anyone can inspect, modify and enhance because the licence under which it is released grants permission to do so. You can find a more detailed definition on the website of the[](https://opensource.org/osd)[Open Source Initiative](https://opensource.org/osd). Similarly,[](https://www.oshwa.org/definition/)[Open Source Hardware Association](https://www.oshwa.org/definition/) defines open-source hardware as “hardware whose design is made publicly available so that anyone can study, modify, distribute, make, and sell the design or hardware based on that design.”
...
**Prepared licence**: Research Institutions or other data publishers can create licences. For example, the[](https://www.data-archive.ac.uk/d/1QbEbEi0v_mnprVG2sfFdzJ-vYVqv4GijnIadOWkrbFE/edit)[UK Data Archive](https://www.data-archive.ac.uk/d/1QbEbEi0v_mnprVG2sfFdzJ-vYVqv4GijnIadOWkrbFE/edit) requires that you sign a standard licence agreement that clarifies the rights and responsibilities of both parties and permits the UK Data Archive to perform its curatorial function.
...
[**Creative Commons**](https://creativecommons.org/): One of the most popular and widely accepted licence providers for most content with the exception of source code. Three versions (CCO, CC-BY, CC-BY-SA) of it are intended for open licensing.[](https://choosealicense.com/licenses/)[Choose a licence](https://choosealicense.com/licenses/) by[GitHub](https://github.com/) provides a list of licences that are specific to software codes.
...
1.  Allow others to use the problem tracker.
2.  Create application programming interface (API) documentation.
3.  Write down your code.
4.  Use coding conventions, including file structure, comments, naming conventions, programming methods, etc.
5.  Include an introduction for contributors.
6.  Provide citation information.
7.  Include any licensing information.
8.  Include a link to your email address.
9.  List all the file versions and the fundamental changes you made.
...
● **Help to publicise the research and share the findings with other researchers –**Because code is so easily accessible, research becomes moreopen and repeatable. It helps the researcher to convey their specific methodology to other experts as well as the community.
...
In addition to its many advantages, scientific programming can accomplish a great deal of work that would be impossible for one person or even a team of people to complete without it. Lise St. Denis's research on climate change at Earth Lab demonstrates that power clearly. Lise uses[](https://twitter.com/lastdenis)[Twitter](https://twitter.com/lastdenis) to notify first responders about emergency situations that result from natural disasters as they develop or progress. Without this technology vital time sensitive information may be missed.
...
<iframe src="https://sa1987.github.io/AgapeOSQuizChapter-3?embedded=true" width="100%" height="600" frameborder="0" marginheight="0" marginwidth="0"  style="border: 3px solid #3fb5bd;" >Loading…</iframe>
...
●       Learn more about open-source software and hardware on [](https://open-science-training-handbook.gitbook.io/book/open-science-basics/open-research-software-and-open-source)[Open Science Training Handbook](https://open-science-training-handbook.gitbook.io/book/open-science-basics/open-research-software-and-open-source) or try to work on a [](https://en.wikipedia.org/wiki/List_of_open-source_hardware_projects)[DIY open-source hardware project](https://en.wikipedia.org/wiki/List_of_open-source_hardware_projects).
...
○       [](https://codecombat.com/)[CodeCombat](https://codecombat.com/): These games take you step by step through ideas, starting with basic computer science and gradually increasing in difficulty.

○       [](https://www.codingame.com/start)[CodinGame](https://www.codingame.com/start): When you have a better grasp, this game is about solving challenges in specific languages.

○       [](https://www.codewars.com/)[CodeWars](https://www.codewars.com/): Get right into programming challenges and experience debugging your code.
