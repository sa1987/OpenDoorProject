...
knitr::include_graphics("images/slide02.png")
```
...
-   If you are an Ireland based researcher, you can check out the list of Open Access Journals that are close to your area in the Irish Open Access Publishers ([IOAP](https://www.ioap.ie/irish-oa-publishers)) website.
